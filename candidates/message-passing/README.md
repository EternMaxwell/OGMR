...
- **Magic**: the complete spell actors, channels, handlers, and typed messages composition containing many spells, entry points, policies, provenance, and diagnostics.
...
- **JSON representation**: a readable object containing the spell actors, channels, handlers, and typed messages topology, spell structures, magic structure, requirements, policies, provenance, and metadata.
...
- **Interpreter output**: a `MagicMessagePassing` structure containing resolved spells, candidate topology, lookup tables, typed attributes, requirements, generation provenance, extension payloads, and diagnostics.
