...
- **Magic**: the complete shared facts read and written by scheduled spell rules composition containing many spells, entry points, policies, provenance, and diagnostics.
...
- **JSON representation**: a readable object containing the shared facts read and written by scheduled spell rules topology, spell structures, magic structure, requirements, policies, provenance, and metadata.
...
- **Interpreter output**: a `MagicBlackboard` structure containing resolved spells, candidate topology, lookup tables, typed attributes, requirements, generation provenance, extension payloads, and diagnostics.
