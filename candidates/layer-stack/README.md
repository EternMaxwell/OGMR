...
- **Spell**: one declarative unit in the ordered layers, masks, blends, overrides, and accumulators model. Spell records may be queries, formulas, component patches, schedules, resource debits, or other candidate-shaped operations with requirements, validation bounds, metadata, and extension data.
