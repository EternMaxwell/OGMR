...
- **Spell**: one declarative unit in the timed tracks, clips, curves, markers, and synchronization rules model. Spell records may be queries, formulas, component patches, schedules, resource debits, or other candidate-shaped operations with requirements, validation bounds, metadata, and extension data.
