...
```json
{
  ...
  "grammar": {
    "start": "thermal_lift_spell",
    "rules": [
      {
        "symbol": "thermal_lift_spell",
        "emit_spell": 0
      }
    ]
  }
