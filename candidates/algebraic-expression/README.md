...
- **Magic**: the complete typed expressions, functions, formulas, and effect constructors composition containing many spells, entry points, policies, provenance, and diagnostics.
...
- **JSON representation**: a readable object containing the typed expressions, functions, formulas, and effect constructors topology, spell structures, magic structure, requirements, policies, provenance, and metadata.
...
- **Interpreter output**: a `MagicAlgebraicExpression` structure containing resolved spells, candidate topology, lookup tables, typed attributes, requirements, generation provenance, extension payloads, and diagnostics.
