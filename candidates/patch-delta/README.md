...
```json
{
  ...
  "patches": [
    {
      "spell": 0,
      "path": "target.temperature_delta_c",
      "op": "add",
      "value": 20
    },
    {
      "spell": 0,
      "path": "target.upward_force_newtons",
      "op": "add",
      "value": 35
    }
  ],
