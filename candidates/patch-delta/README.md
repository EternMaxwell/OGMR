...
- **Spell**: one declarative unit in the declarative patches that add, replace, scale, or remove world properties model. Spell records may be queries, formulas, component patches, schedules, resource debits, or other candidate-shaped operations with requirements, validation bounds, metadata, and extension data.
