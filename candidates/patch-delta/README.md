...
- **Spell**: one declarative unit in the the declarative patches that add, replace, scale, or remove world properties model. Spell records may be queries, formulas, component patches, schedules, resource debits, or other candidate-shaped operations with requirements, validation bounds, metadata, and extension data.
...
```json
{
  "spell_encoding": "patch_delta_operation_records",
  "patches": [
    {
      "patch": "patch_0",
      "handle": "air_column",
...
```json
{
  ...
  "patches": [
    {
      "op": "add",
      "path": "/resolved/spells/0",
      "spell": 0
    },
    {
      "op": "replace_or_merge",
      "path": "/resolved/spells/1",
      "spell": 1
    },
    {
      "op": "replace_or_merge",
      "path": "/resolved/spells/2",
      "spell": 2
    }
  ]
}
