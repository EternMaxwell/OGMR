# State Machine Format Candidate

## Summary

This candidate represents magic through states, transitions, guards, actions, and lifecycle phases. It is intended to be serializable, procedurally generatable, interpretable into performer-facing data, and usable by games ranging from simple rule worlds to detailed physical simulations.
...
- **Magic**: the complete states, transitions, guards, actions, and lifecycle phases composition containing many spells, entry points, policies, provenance, and diagnostics.
...
- **JSON representation**: a readable object containing the states, transitions, guards, actions, and lifecycle phases topology, spell structures, magic structure, requirements, policies, provenance, and metadata.
...
- **Interpreter output**: a `MagicStateMachine` structure containing resolved spells, candidate topology, lookup tables, typed attributes, requirements, generation provenance, extension payloads, and diagnostics.
