...
```json
{
  ...
  "root": {
    ...
    "children": [
      {
        "type": "condition",
        "requires_target": "selected_volume"
      },
      {
        "type": "action",
        "spell": 0
