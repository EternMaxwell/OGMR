...
- **Magic**: the complete sources, sinks, transforms, samplers, and spatial or abstract fields composition containing many spells, entry points, policies, provenance, and diagnostics.
...
- **JSON representation**: a readable object containing the sources, sinks, transforms, samplers, and spatial or abstract fields topology, spell structures, magic structure, requirements, policies, provenance, and metadata.
...
- **Interpreter output**: a `MagicFieldNetwork` structure containing resolved spells, candidate topology, lookup tables, typed attributes, requirements, generation provenance, extension payloads, and diagnostics.
