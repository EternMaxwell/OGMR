...
- **Spell**: one declarative unit in the the sources, sinks, transforms, samplers, and spatial or abstract fields model. Spell records may be queries, formulas, component patches, schedules, resource debits, or other candidate-shaped operations with requirements, validation bounds, metadata, and extension data.
...
```json
{
  "spell_encoding": "field_node_operation_records",
  "field_nodes": [
    {
      "field": "field_0",
      "handle": "air_column",
